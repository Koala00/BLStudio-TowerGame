...
public class MouseCameraControl : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        if (yaw.isActivated())
        {
            ...
            transform.rotation = new Quaternion(transform.rotation.x, transform.rotation.y + rotationX, transform.rotation.z, transform.rotation.w);
        }
        ...
        Quaternion cameraRotationBackup = transform.rotation;
        ...
        if (scroll.isActivated())
        {
            ...
            transform.rotation = cameraRotationBackup;
            transform.Translate(0, 0, translateZ);
            transform.rotation = new Quaternion(0, 0, 0, 0);
        }
